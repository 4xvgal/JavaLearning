...
public class SynchronizedLJM03 {
    public static void main(String[] args) {
        ...
        String [] korText = { "동해물과 백두산이 마르고 닳도록, ",
                ...
                "무궁화 삼천리 화려강산, ",
                "대한 사람 대한으로 길이 보전하세" };
        Thread th1 = new WorkerThread(p, engText);//영문출력
        Thread th2 = new WorkerThread(p, korText);//국문출력
        // 두 스레드를 실행시킨다.
        th1.start();
        th2.start();
    }
...
class SharedPrinter {
    ...
    synchronized void print(String text) { // line 31
        // Thread.yield();
